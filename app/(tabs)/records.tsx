        ...
        <View style={styles.wrapperBox}>
          ...
          {showAsset && (
            <View style={styles.innerCard}>
              ...
              />
              <Field
                label="Average Monthly Expenses on this asset (₹)"
                value={expense}
                onChange={setExpense}
                numeric
              />
        ...
        <View style={styles.wrapperBox}>
          ...
          {showLiability && (
            <View style={styles.innerCard}>
              ...
              <Field
                label="Institution/Bank (provider if any)"
                value={institution}
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalBox}>
              ...
              {(() => {
                ...
                return (
                  <View
                    style={[styles.badge, { backgroundColor: riskStyle.bg }]}
                  >
              ...
              <View style={styles.modalActions}>
                ...
                >
                  {loading ? (
                    ...
                    <Text style={styles.btnText}>Delete Liability</Text>
                  )}
                </TouchableOpacity>
                <TouchableOpacity
